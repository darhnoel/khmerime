...
run_rm rm -f "${INSTALL_LIBEXEC_DIR}/ibus_candidate_renderer.py"
run_rm rm -f "${INSTALL_LIBEXEC_DIR}/ibus_component.py"
run_rm rm -f "${INSTALL_LIBEXEC_DIR}/ibus_debounced_bridge_work.py"
run_rm rm -f "${INSTALL_LIBEXEC_DIR}/ibus_refinement_scheduler.py"
run_rm rm -f "${INSTALL_LIBEXEC_DIR}/ibus_segmented_preview_renderer.py"
run_rm rm -f "${INSTALL_LIBEXEC_DIR}/ibus_segmented_preview_scheduler.py"
# Legacy module names (pre-rename) — keep so upgrades clean up orphans.
...
rm -f "${LEGACY_USER_LIBEXEC_DIR}/ibus_candidate_renderer.py"
rm -f "${LEGACY_USER_LIBEXEC_DIR}/ibus_component.py"
rm -f "${LEGACY_USER_LIBEXEC_DIR}/ibus_debounced_bridge_work.py"
rm -f "${LEGACY_USER_LIBEXEC_DIR}/ibus_refinement_scheduler.py"
rm -f "${LEGACY_USER_LIBEXEC_DIR}/ibus_segmented_preview_renderer.py"
rm -f "${LEGACY_USER_LIBEXEC_DIR}/ibus_segmented_preview_scheduler.py"
# Legacy module names (pre-rename) — keep so upgrades clean up orphans.
